...
This is the code base for ANLP HUJI course exercise 1: fine-tuning `bert-base-uncased` for **paraphrase detection on MRPC** (GLUE).
...
If you use `--do_predict`, a `predictions.txt` file will be generated with one line per test example: `sentence1###sentence2###label`.
